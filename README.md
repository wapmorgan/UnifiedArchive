...
5. Further you can unpack any internal catalog with files on a disk. Including
...
2. If the `source` doesn't come to an end on "/"" or "*", it means there has to
be a file.
...
```
- obtaining the list of files in archive. The symbol of division of catalogs can
be both a slash, and a backslash.
...
Yes, you didn't mishear - UnifedArchive provides full realization of the
...
PCLZIP_OPT_NO_COMPRESSION. This option allows to disconnect compression for
